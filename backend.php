...
// -----------------------------------------------------------------
// CONFIGURATION: Ensure your real Gemini API Key is active here
// -----------------------------------------------------------------
$apiKey = "AIzaSyC90JaIWYBID1A4QHOCcTxA9wnLIaBAeTU"; 
...
if ($response) {
    ...
    // If there is an API error message from Google, show it directly for debugging
